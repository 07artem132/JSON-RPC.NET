...
- **Still open:** all 20 audit findings shipped/resolved. One **opt-in enhancement** remains (not an audit finding): `aot-rpc-dispatch` — source-gen `AddLocalRpcMethod` to make RPC dispatch (not just discovery) Native-AOT-clean.
